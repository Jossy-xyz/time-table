...
```typescript
// Old way
const response = await fetch('http://localhost:8080/student/get?username=admin');
...
*This document is a living guide. Update it as implementation progresses and new insights emerge.*